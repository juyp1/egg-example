...
module.exports = app => {
  ...
  router.get('/comm/userlist', jwt, controller.comm.userlist);
  router.post('/project/add', jwt, controller.project.add);
  router.get('/project/userlist/:id', jwt, controller.project.projectUsers);
